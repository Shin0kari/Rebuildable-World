...
public class ModBlocks {
    ...
    public static final Block USELESS_BLOCK = registerBlock("useless_ore",
        new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.LAPIS_ORE).strength(2f).sounds(BlockSoundGroup.GRASS), UniformIntProvider.create(1, 3)));
    
    public static final Block USELESS_DEEPSLATE_ORE = registerBlock("useless_deepslate_ore",
        new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_LAPIS_ORE).strength(4f).sounds(BlockSoundGroup.SLIME), UniformIntProvider.create(2, 6)));
    
    public static final Block USELESS_NETHER_ORE = registerBlock("useless_nether_ore",
        new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.NETHER_QUARTZ_ORE).strength(1.5f).sounds(BlockSoundGroup.NETHER_BRICKS), UniformIntProvider.create(1, 4)));
    
    public static final Block USELESS_END_ORE = registerBlock("useless_end_ore",
        new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.END_STONE_BRICKS).strength(2.5f), UniformIntProvider.create(4, 8)));
